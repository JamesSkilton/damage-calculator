...
export const calculatorModes = [
  ...
  },
  {
    ...
    title: 'All vs One',
    description:
      'A defensive view for comparing multiple attackers into one target.',
    placeholderTodo:
      'TODO: migrate the all-vs-one attacker comparison flow into this route.',
  },
  {
    slug: 'champions',
    label: 'Champions',
    title: 'Champions',
    description:
      'A mode dedicated to champion battles and their calculator presets.',
    placeholderTodo:
      'TODO: migrate the champion preset experience into this route.',
  },
  {
    slug: 'randoms',
    ...
    description:
      'Random battle matchups with the same shared calculator shell.',
    placeholderTodo:
      'TODO: migrate the random battles presets and matchup rules into this route.',
  },
  {
    slug: 'oms',
    ...
    placeholderTodo:
      'TODO: migrate the other metagames preset catalog into this route.',
  },
